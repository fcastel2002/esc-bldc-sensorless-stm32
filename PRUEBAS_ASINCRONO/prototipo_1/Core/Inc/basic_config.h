...
//////////////////////
/// ALIGN CONFIG
#define ALIGN_TIME 20 //
#define DC_ALIGN 2400	// DDUTY CYCLE 1300 -> 72% PARA ALIGNMENT
///
...
#define DC_STARTUP_INIT 1000
#define DC_STARTUP_END 1100
#define DC_STARTUP_STEP 50
#define TIME_STARTUP_COMMUTATION_INIT 80
#define TIME_STARTUP_COMMUTATION_FINAL 30
#define TIME_STARTUP_STEP 4 // commutation time step time 10ms
