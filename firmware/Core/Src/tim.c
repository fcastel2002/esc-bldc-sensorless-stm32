...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PB10     ------> TIM2_CH3
    */
    GPIO_InitStruct.Pin = W_Pin|U_Pin;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB0     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = EN_U_PWM_Pin|EN_V_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = EN_W_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(EN_W_PWM_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB10     ------> TIM2_CH3
    */
    HAL_GPIO_DeInit(GPIOA, W_Pin|U_Pin);

    HAL_GPIO_DeInit(V_GPIO_Port, V_Pin);
