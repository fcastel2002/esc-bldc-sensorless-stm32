...
void processCommand(char* cmd)
{
  ...
  if (parsed < 1 ||
      (parsed < 2 && (strcmp(action_str, "RUN") != 0 && strcmp(action_str, "STOP") != 0 &&
                      strcmp(action_str, "ESTOP") != 0))) {
  ...
  if (param == PARAM_UNKNOWN &&
      (action != ACTION_RUN && action != ACTION_STOP && action != ACTION_EMERGENCY)) {
...
{
  if (strcmp(param_str, "PWM_FREQ") == 0)
    return PARAM_PWM_FREQ;
  if (strcmp(param_str, "POLEP") == 0)
    return PARAM_POLEP;
  if (strcmp(param_str, "CURRENT_LIMIT") == 0)
    return PARAM_CURRENT_LIMIT;
  if (strcmp(param_str, "TEMP_LIMIT") == 0)
    return PARAM_TEMP_LIMIT;
  if (strcmp(param_str, "ALL") == 0)
    return PARAM_ALL;
  if (strcmp(param_str, "SPEED") == 0)
    return PARAM_SPEED;
  if (strcmp(param_str, "TEMP") == 0)
    return PARAM_TEMP;
  if (strcmp(param_str, "CRRT") == 0)
    return PARAM_CURRENT;
  if (strcmp(param_str, "START") == 0)
    return PARAM_START;
  if (strcmp(param_str, "STOP") == 0)
    return PARAM_STOP;
  if (strcmp(param_str, "RATE") == 0)
    return PARAM_RATE;
...
CommandAction parseAction(char* action_str)
{
  ...
  if (strcmp(action_str, "STOP") == 0)
    return ACTION_STOP;
  if (strcmp(action_str, "ESTOP") == 0)
    return ACTION_EMERGENCY;
  if (strcmp(action_str, "LOG") == 0)
