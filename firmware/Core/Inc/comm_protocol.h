...
#define COMM_PARAM_BEMF_BLANKING_US 0x12U
...
#define COMM_LOG_PARAM_CURRENT_U COMM_LOG_PARAM_CURRENT
#define COMM_LOG_PARAM_CURRENT_V 0x04U
#define COMM_LOG_PARAM_BEMF_PERIOD 0x05U

#define COMM_TELEMETRY_FLAG_VALID (1U << 0)
#define COMM_TELEMETRY_FLAG_CALIBRATED (1U << 1)
#define COMM_TELEMETRY_FLAG_SATURATED (1U << 2)
#define COMM_TELEMETRY_FLAG_OVERCURRENT (1U << 3)
