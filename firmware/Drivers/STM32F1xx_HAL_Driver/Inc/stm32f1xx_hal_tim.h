  ...
  uint32_t
      RepetitionCounter; /*!< Specifies the repetition counter value. Each time the RCR downcounter
                              ...
                              This means in PWM mode that (N+1) corresponds to:
                               ...
                               GP timers: this parameter must be a number between Min_Data = 0x00
                            and Max_Data = 0xFF. Advanced timers: this parameter must be a number
...
typedef struct {
  ...
  uint32_t ClearInputPrescaler; /*!< TIM Clear Input prescaler
                                     This parameter must be 0: When OCRef clear feature is used with
                                   ETR source, ETR prescaler must be off */
...
typedef struct {
  ...
  uint32_t DeadTime; /*!< TIM dead Time, This parameter can be a number between Min_Data = 0x00 and
                        Max_Data = 0xFF */
  ...
  uint32_t BreakFilter; /*!< Specifies the break input filter.This parameter can be a number between
                           Min_Data = 0x0 and Max_Data = 0xF */

  uint32_t AutomaticOutput; /*!< TIM Automatic Output Enable state, This parameter can be a value of
                               @ref TIM_AOE_Bit_Set_Reset */
...
#define TIM_ENCODERMODE_TI1                                                                        \
  TIM_SMCR_SMS_0 /*!< Quadrature encoder mode 1, x2 mode, counts up/down on TI1FP1 edge depending  \
                    on TI2FP2 level  */
#define TIM_ENCODERMODE_TI2                                                                        \
  TIM_SMCR_SMS_1 /*!< Quadrature encoder mode 2, x2 mode, counts up/down on TI2FP2 edge depending  \
                    on TI1FP1 level. */
...
#define TIM_AUTOMATICOUTPUT_ENABLE                                                                 \
  TIM_BDTR_AOE /*!< MOE can be set by software or automatically at the next update event (if none  \
                  of the break inputs BRK and BRK2 is active) */
/**
 * @}
 */
