...
#define IS_RCC_PLL2(__PLL__)                                                                       \
  (((__PLL__) == RCC_PLL2_NONE) || ((__PLL__) == RCC_PLL2_OFF) || ((__PLL__) == RCC_PLL2_ON))
 ...
 */
    ...
    defined(STM32F103xG) || defined(STM32F105xC) || defined(STM32F107xC) || defined(STM32F100xE)
 ...
 */
    ...
    defined(STM32F105xC) || defined(STM32F107xC) || defined(STM32F103xE) || defined(STM32F103xG)
 ...
 * @param  __USBCLKSOURCE__ specifies the USB clock source.
 *          This parameter can be one of the following values:
 *            @arg @ref RCC_USBCLKSOURCE_PLL_DIV2 PLL clock divided by 2 selected as USB OTG FS
 * clock
 *            @arg @ref RCC_USBCLKSOURCE_PLL_DIV3 PLL clock divided by 3 selected as USB OTG FS
 * clock
 */
#define __HAL_RCC_USB_CONFIG(__USBCLKSOURCE__)                                                     \
 ...
 *         In this case, you have to select another source of the system clock, disable the PLL2 and
 * PLLI2S and then change the PREDIV2 factor.
