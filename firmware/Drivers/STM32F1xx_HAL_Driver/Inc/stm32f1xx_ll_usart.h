...
typedef struct {
  ...
  uint32_t
      HardwareFlowControl; /*!< Specifies whether the hardware flow control mode is enabled or
                              disabled. This parameter can be a value of @ref USART_LL_EC_HWCONTROL.
...
typedef struct {
  ...
  uint32_t ClockPolarity; /*!< Specifies the steady state of the serial clock.
                             ...
                             functions @ref LL_USART_SetClockPolarity(). For more details, refer to
  ...
  uint32_t LastBitClockPulse; /*!< Specifies whether the clock pulse corresponding to the last
                                 ...
                                 USART_LL_EC_LASTCLKPULSE.
                                   ...
                                   USART HW configuration can be modified afterwards using unitary
                                 functions @ref LL_USART_SetLastClkPulseOutput(). For more details,
