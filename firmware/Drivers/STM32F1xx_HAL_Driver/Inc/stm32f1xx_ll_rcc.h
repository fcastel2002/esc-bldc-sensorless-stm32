...
#define LL_RCC_I2S2_CLKSOURCE_PLLI2S_VCO                                                           \
  (uint32_t)(RCC_CFGR2_I2S2SRC |                                                                   \
             (RCC_CFGR2_I2S2SRC >> 16U)) /*!< PLLI2S VCO clock selected as I2S2 clock entry */
...
#define LL_RCC_I2S3_CLKSOURCE_PLLI2S_VCO                                                           \
  (uint32_t)(RCC_CFGR2_I2S3SRC |                                                                   \
             (RCC_CFGR2_I2S3SRC >> 16U)) /*!< PLLI2S VCO clock selected as I2S3 clock entry */
/**
 * @}
 */
...
#define LL_RCC_PLLSOURCE_HSE_DIV_10                                                                \
  (RCC_CFGR_PLLSRC |                                                                               \
   RCC_CFGR2_PREDIV1_DIV10) /*!< HSE/10 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_11                                                                \
  (RCC_CFGR_PLLSRC |                                                                               \
   RCC_CFGR2_PREDIV1_DIV11) /*!< HSE/11 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_12                                                                \
  (RCC_CFGR_PLLSRC |                                                                               \
   RCC_CFGR2_PREDIV1_DIV12) /*!< HSE/12 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_13                                                                \
  (RCC_CFGR_PLLSRC |                                                                               \
   RCC_CFGR2_PREDIV1_DIV13) /*!< HSE/13 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_14                                                                \
  (RCC_CFGR_PLLSRC |                                                                               \
   RCC_CFGR2_PREDIV1_DIV14) /*!< HSE/14 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_15                                                                \
  (RCC_CFGR_PLLSRC |                                                                               \
   RCC_CFGR2_PREDIV1_DIV15) /*!< HSE/15 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_16                                                                \
  (RCC_CFGR_PLLSRC |                                                                               \
   RCC_CFGR2_PREDIV1_DIV16) /*!< HSE/16 clock selected as PLL entry clock source */
#if defined(RCC_CFGR2_PREDIV1SRC)
 ...
 * @param  __INPUTFREQ__ PLL Input frequency (based on HSE div Prediv1 / HSI div 2 / PLL2 div
 * Prediv1)
 ...
 * @note ex: @ref __LL_RCC_CALC_PLLI2SCLK_FREQ (HSE_VALUE, @ref LL_RCC_PLLI2S_GetMultiplicator (),
 * @ref LL_RCC_HSE_GetPrediv2 ());
