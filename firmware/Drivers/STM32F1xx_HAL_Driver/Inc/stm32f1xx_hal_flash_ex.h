...
typedef struct {
  ...
  uint32_t PageAddress; /*!< PageAdress: Initial FLASH page address to erase when mass erase is
                           disabled This parameter must be a number between Min_Data = 0x08000000
                           and Max_Data = FLASH_BANKx_END (x = 1 or 2 depending on devices)*/

  uint32_t NbPages; /*!< NbPages: Number of pagess to be erased.
                         This parameter must be a value between Min_Data = 1 and Max_Data = (max
...
typedef struct {
  ...
  uint8_t USERConfig; /*!< USERConfig: Program the FLASH User Option Byte:
                           ...
                           This parameter can be a combination of @ref FLASHEx_OB_IWatchdog, @ref
  ...
  uint8_t
      DATAData; /*!< DATAData: Data to be stored in the option byte DATA
