# ESC BLDC Sensorless STM32 — Contexto para agentes

> [!IMPORTANT]
> Si el usuario pide actualizar este archivo, actualizar también `CLAUDE.md` en el mismo directorio con los mismos cambios de contenido. Ambos archivos deben mantenerse sincronizados.
