...
void zero_crossing(uint8_t fase){
    ...
    // Actualizar el periodo y programar la conmutación (sin filtrado ni validaciones extra)
    filtered_speed = period_temp;
