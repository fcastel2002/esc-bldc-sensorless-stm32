...
%   includes esc_validation_v1, a flat typed contract for GUI import.
...
manifest = struct( ...
    ...
    "targetRpm", targetRpm, ...
    "stopTimeSeconds", localField(config, "stopTimeSeconds", simulationTime(end) - simulationTime(1)), ...
...
save(outputPath, "validationVector", "manifest", "esc_validation_v1", "-v7");
end
